...
<table class="table table-striped">
    ...
    <tbody>
	  ...
	  <?php
	    $res=mysqli_query($link,"select * from tbluser1");
...
{
	mysqli_query($link,"update tbluser1 set firstname='$_POST[lastname]' where firstname='$_POST[firstname]'") or die(mysqli_error($link));
	?>
	<script type="text/javascript">
	window.location.href=window.location.href;
	</script>
